...
export const metadata = {
  title: "Dr. Oliveira Advocacia — Advocacia Criminal",
  description: "Orientação jurídica em Advocacia Criminal: defesa técnica do inquérito ao júri.",
}
    ...
    <>
      ...
      <main className="bg-[linear-gradient(165deg,#082533,#081b26)] text-[#efebe6]">
        <div className="mx-auto max-w-4xl px-5 py-20 text-center">
          ...
          <h1 className="mt-4 font-serif text-3xl font-bold md:text-5xl">Defesa criminal em todas as fases</h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-[#aeb8bd]">Do inquérito ao júri, cada fase tem defesa. Escolha o assunto para saber como agir.</p>
        </div>
        {list.length > 0 ? (
